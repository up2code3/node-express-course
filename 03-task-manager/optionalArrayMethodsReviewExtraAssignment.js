...
console.log("__________________________________________________________________________________Challenge 1");
// const newNames = names.map(
//   (name) => name.split(' ').pop())

// console.log(newNames,)
console.log("__________________________________________________________________________________Answer 1");

console.log("__________________________________________________________________________________Challenge 2");
// const correct = /^\w+ \w+$/;

// const newNames = names.filter((name) => {
//   return name.match(correct);
// });

// const newNames = names.filter((name) => correct.test(name));
// console.log(newNames);

console.log("__________________________________________________________________________________Answer 2");

console.log("__________________________________________________________________________________Challenge 3");
...
//   .filter(Boolean)
//   .map((single) => {
//     return single[0].toUpperCase() + single.slice(1).toLowerCase()
//   })
//   .join(' ')
// })
...
console.log("__________________________________________________________________________________Answer 3");

console.log("__________________________________________________________________________________Challenge 4");

//valid format
const correct = /^\w+ \w+$/;

//filter out bad names
const GoodNames = names.filter((name) => {
  return name
  .match(correct)
});

//convert to title case
const TitleNames = GoodNames.map((name) => {
    return name
    .split(' ')
    .filter(Boolean)
    .map((single) => {
  ...
  //no names ending in z pop it off
  const noZ = TitleNames.filter((name) => {
    const last = name.split(' ').pop();
    return !last.endsWith('z')
  })

// create welcome nessgae 

noZ.forEach((name) => {
  console.log( `${name} please join the club`)
})
...
console.log("__________________________________________________________________________________Answer 4");
///////////////////////////////////////////////////////////////////////////////
